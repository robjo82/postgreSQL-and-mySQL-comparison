...
cur.execute("ALTER TABLE formation AUTO_INCREMENT = 1")
...
# Restart the sequence
cur.execute("ALTER TABLE equipe AUTO_INCREMENT = 1")
...
# Restart the sequence
cur.execute("ALTER TABLE etudiant AUTO_INCREMENT = 1")
...
# Restart the sequence
cur.execute("ALTER TABLE activite AUTO_INCREMENT = 1")
...
for i in range(100000):
    id_etudiant = random.randint(1, 1000000)
    id_activite = random.randint(1, 100000)
...
# Restart the sequence
cur.execute("ALTER Table challenge AUTO_INCREMENT = 1")
